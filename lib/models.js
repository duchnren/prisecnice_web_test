...
//  location.reload(true);
  ...
  $('#coo').val("br");
  $('.mapsec').show();
  $('.hideMapCZ').html("Skrýt mapu");
  $('.hideMapEN').html("Hide the map");
  $('.hideMapFR').html("");
  $('.hideDesCZ').html("Skrýt popis");
  $('.hideDesEN').html("Hide the description");
  $('.hideDesFR').html("");
...
//  if ($('.mapsec').css('display')=="block") {
    $('.mapsec').hide();
    $('.hideMapCZ').html("Zobrazit mapu");
    $('.hideMapEN').html("Show the map");
    $('.hideMapFR').html("");
...
$('#checkDes').on("click", function () {
  ...
  if (chkDes) {
    $('#obsah-popis').hide();
    $('#photo').hide();
    $('.hideDesCZ').html("Zobrazit popis");
    $('.hideDesEN').html("Show the description");
    $('.hideDesFR').html("");
  }
  else {
    $('#obsah-popis').show();
